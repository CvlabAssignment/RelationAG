...
def get_data(name, split_id, data_dir, height, width, batch_size, num_instances,
	...
	if name == 'cuhk03labeled':
		...
		dataset = data_manager.init_imgreid_dataset(
		     name=dataset_name, split_id=split_id,
		...
		dataset.images_dir =  '/media/sungheui/Temp/KIST/test_data/images'
...
def main(args):
	...
	for epoch in range(start_epoch, args.epochs):
		...
		trainer.train(epoch, optimizer, random_erasing=args.random_erasing, empty_cache=args.empty_cache)
...
if __name__ == '__main__':
	...
	# data
	parser.add_argument('-d', '--dataset', type=str, default='kist') #cuhk03labeled
	...
	parser.add_argument('--num-instances', type=int, default=2,
						help="each minibatch consist of "
							 ...
							 "default: 4")
	# model
	parser.add_argument('-a', '--arch', type=str, default='resnet50_rga',  #resnet50-19c8e357.pth
	...
	parser.add_argument('--use_bn', type=str2bool, default=True) #True
	# loss
