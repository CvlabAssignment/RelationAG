...
from cuhk03.cuhk03_release import *
...
class CUHK03(object):
    ...
    def __init__(self, root='/home/sungheui/Downloads/Relation-Aware-Global-Attention-Networks-master', split_id=0, cuhk03_labeled=False, cuhk03_classic_split=False, verbose=True,
                 **kwargs):
        super(CUHK03, self).__init__()
        self.dataset_dir = osp.join(root, self.dataset_dir)
        self.data_dir = osp.join(self.dataset_dir, 'cuhk03_release')
        self.raw_mat_path = osp.join(self.data_dir, 'cuhk-03.mat ')
        self.raw_mat_path = '/home/sungheui/Desktop/kist/cuhk03_release/cuhk-03.mat'
